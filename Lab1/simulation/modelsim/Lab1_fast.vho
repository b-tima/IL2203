...
SIGNAL \add_overflow~1_combout\ : std_logic;
SIGNAL \add_overflow~0_combout\ : std_logic;
SIGNAL \add_overflow~combout\ : std_logic;
...
-- Equation(s):
-- \Mux6~5_combout\ = (\A~combout\(0) & ((\B~combout\(0)) # (\OP~combout\(0)))) # (!\A~combout\(0) & (\B~combout\(0) & \OP~combout\(0)))
...
-- Equation(s):
-- \Mux6~1_combout\ = (\OP~combout\(2) & ((\OP~combout\(1)) # (\OP~combout\(0))))
...
-- Equation(s):
-- \Mux5~3_combout\ = (\OP~combout\(1) & ((\OP~combout\(2) & ((\Mux5~1_combout\))) # (!\OP~combout\(2) & (\Mux5~2_combout\)))) # (!\OP~combout\(1) & (((\Mux5~1_combout\))))
...
-- Equation(s):
-- \Mux4~3_combout\ = (\OP~combout\(1) & ((\OP~combout\(2) & ((\Mux4~1_combout\))) # (!\OP~combout\(2) & (\Mux4~2_combout\)))) # (!\OP~combout\(1) & (((\Mux4~1_combout\))))
...
-- Equation(s):
-- \Mux3~3_combout\ = (\OP~combout\(1) & ((\OP~combout\(2) & ((\Mux3~1_combout\))) # (!\OP~combout\(2) & (\Mux3~2_combout\)))) # (!\OP~combout\(1) & (((\Mux3~1_combout\))))
...
-- Equation(s):
-- \Mux2~2_combout\ = (\B~combout\(4) & ((\A~combout\(4)) # (\OP~combout\(0)))) # (!\B~combout\(4) & (\A~combout\(4) & \OP~combout\(0)))
...
-- Equation(s):
-- \Mux0~2_combout\ = (\B~combout\(6) & ((\OP~combout\(0)) # (\A~combout\(6)))) # (!\B~combout\(6) & (\OP~combout\(0) & \A~combout\(6)))
...
-- Equation(s):
-- \Z_Flag~0_combout\ = (\Mux3~3_combout\) # ((\Mux5~3_combout\) # ((\Mux4~3_combout\) # (\Mux6~6_combout\)))
...
-- Equation(s):
-- \Z_Flag~1_combout\ = (\Mux2~3_combout\) # ((\Z_Flag~0_combout\) # ((\Mux1~3_combout\) # (\Mux0~3_combout\)))
...
-- Equation(s):
-- \sub_overflow~0_combout\ = (\A~combout\(6) & (!\B~combout\(6) & !\Mux0~3_combout\)) # (!\A~combout\(6) & (\B~combout\(6) & \Mux0~3_combout\))
...
\add_overflow~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \add_overflow~1_combout\ = (\OP~combout\(1)) # ((\OP~combout\(2)) # (\OP~combout\(0)))
...
PORT MAP (
	...
	datac => \OP~combout\(2),
	datad => \OP~combout\(0),
	combout => \add_overflow~1_combout\);

-- Location: LCCOMB_X2_Y12_N30
\add_overflow~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \add_overflow~0_combout\ = (\A~combout\(6) & ((\Mux0~3_combout\) # (!\B~combout\(6)))) # (!\A~combout\(6) & ((\B~combout\(6)) # (!\Mux0~3_combout\)))
...
PORT MAP (
	...
	datac => \B~combout\(6),
	datad => \Mux0~3_combout\,
	combout => \add_overflow~0_combout\);

-- Location: LCCOMB_X2_Y12_N26
add_overflow : cycloneii_lcell_comb
-- Equation(s):
-- \add_overflow~combout\ = (\add_overflow~1_combout\ & (\add_overflow~combout\)) # (!\add_overflow~1_combout\ & ((!\add_overflow~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \add_overflow~combout\,
	datac => \add_overflow~1_combout\,
	datad => \add_overflow~0_combout\,
	combout => \add_overflow~combout\);

-- Location: LCCOMB_X3_Y12_N16
\O_Flag~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \O_Flag~0_combout\ = (\sub_overflow~combout\) # (\add_overflow~combout\)
...
-- pragma translate_on
PORT MAP (
	datac => \sub_overflow~combout\,
	datad => \add_overflow~combout\,
