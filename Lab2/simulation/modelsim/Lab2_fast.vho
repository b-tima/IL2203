...
SIGNAL \rf|QB[3]~2_combout\ : std_logic;
...
SIGNAL \rf|QA[0]~11_combout\ : std_logic;
SIGNAL \the_best_alu_in_kista|Mux2~4_combout\ : std_logic;
SIGNAL \the_best_alu_in_kista|Add0~5_cout\ : std_logic;
...
SIGNAL \the_best_alu_in_kista|Add0~7\ : std_logic;
...
SIGNAL \rf|QA[2]~3_combout\ : std_logic;
SIGNAL \rf|QA[2]~4_combout\ : std_logic;
SIGNAL \rf|register_arr[3][2]~regout\ : std_logic;
SIGNAL \rf|QB[2]~3_combout\ : std_logic;
SIGNAL \rf|QB[2]~4_combout\ : std_logic;
SIGNAL \rf|QB[2]~9_combout\ : std_logic;
SIGNAL \the_best_alu_in_kista|Mux1~7_combout\ : std_logic;
SIGNAL \rf|QA[2]~5_combout\ : std_logic;
...
SIGNAL \rf|QB[3]~0_combout\ : std_logic;
SIGNAL \rf|QB[3]~1_combout\ : std_logic;
SIGNAL \rf|QA[3]~0_combout\ : std_logic;
SIGNAL \rf|QA[3]~1_combout\ : std_logic;
SIGNAL \rf|QA[3]~2_combout\ : std_logic;
...
SIGNAL \the_best_alu_in_kista|o_tmp~4_combout\ : std_logic;
SIGNAL \the_best_alu_in_kista|o_tmp~5_combout\ : std_logic;
...
-- Equation(s):
-- \cd|Equal0~3_combout\ = (\cd|counter\(14) & (\cd|counter\(12) & (!\cd|counter\(15) & \cd|counter\(13))))
...
PORT MAP (
	...
	sdata => \rf|register_arr~0_combout\,
	sload => VCC,
	ena => \rf|register_arr[1][1]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \rf|register_arr[1][3]~regout\);

-- Location: LCCOMB_X5_Y15_N10
\rf|QB[3]~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QB[3]~2_combout\ = (\ReadB~combout\ & \rf|QB[3]~1_combout\)
...
PORT MAP (
	datac => \ReadB~combout\,
	datad => \rf|QB[3]~1_combout\,
	combout => \rf|QB[3]~2_combout\);

-- Location: LCCOMB_X3_Y15_N20
\the_best_alu_in_kista|Add0~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \the_best_alu_in_kista|Add0~1_combout\ = \OP~combout\(0) $ (((\ReadB~combout\ & \rf|QB[2]~4_combout\)))
...
PORT MAP (
	dataa => \ReadB~combout\,
	datac => \OP~combout\(0),
	datad => \rf|QB[2]~4_combout\,
	combout => \the_best_alu_in_kista|Add0~1_combout\);

-- Location: LCCOMB_X2_Y15_N12
\rf|QB[1]~5\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QB[1]~5_combout\ = (\RB~combout\(1) & (\RB~combout\(0))) # (!\RB~combout\(1) & ((\RB~combout\(0) & ((\rf|register_arr[1][1]~regout\))) # (!\RB~combout\(0) & (\rf|register_arr[0][1]~regout\))))
...
\rf|QB[1]~6\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QB[1]~6_combout\ = (\RB~combout\(1) & ((\rf|QB[1]~5_combout\ & ((\rf|register_arr[3][1]~regout\))) # (!\rf|QB[1]~5_combout\ & (\rf|register_arr[2][1]~regout\)))) # (!\RB~combout\(1) & (((\rf|QB[1]~5_combout\))))
...
-- Equation(s):
-- \the_best_alu_in_kista|Add0~2_combout\ = \OP~combout\(0) $ (((\ReadB~combout\ & \rf|QB[1]~6_combout\)))
...
\the_best_alu_in_kista|Add0~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \the_best_alu_in_kista|Add0~3_combout\ = \OP~combout\(0) $ (((\ReadB~combout\ & \rf|QB[0]~8_combout\)))
...
-- Equation(s):
-- \rf|QB[1]~10_combout\ = (\ReadB~combout\ & \rf|QB[1]~6_combout\)
...
-- Equation(s):
-- \the_best_alu_in_kista|Mux2~10_combout\ = (\OP~combout\(0) & ((\rf|QB[1]~10_combout\) # ((\ReadA~combout\ & \rf|QA[1]~7_combout\)))) # (!\OP~combout\(0) & (\ReadA~combout\ & (\rf|QA[1]~7_combout\ & \rf|QB[1]~10_combout\)))
...
-- Equation(s):
-- \cd|counter~12_combout\ = (!\cd|Equal0~7_combout\ & \cd|Add0~44_combout\)
...
-- Equation(s):
-- \cd|Equal0~0_combout\ = (!\cd|counter\(8) & (!\cd|counter\(9) & (\cd|counter\(11) & !\cd|counter\(10))))
...
-- Equation(s):
-- \cd|Equal0~1_combout\ = (\cd|counter\(6) & (!\cd|counter\(7) & (!\cd|counter\(5) & !\cd|counter\(4))))
...
-- Equation(s):
-- \cd|Equal0~7_combout\ = (\cd|counter\(24) & (\cd|Equal0~6_combout\ & (\cd|Equal0~4_combout\ & \cd|Equal0~5_combout\)))
...
\rf|register_arr~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|register_arr~7_combout\ = (\RESET~combout\ & ((\IE~combout\ & (\INPUT~combout\(0))) # (!\IE~combout\ & ((\the_best_alu_in_kista|SUM\(0))))))
...
PORT MAP (
	...
	datad => \the_best_alu_in_kista|SUM\(0),
...
\rf|register_arr[3][1]~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|register_arr[3][1]~4_combout\ = ((\WAddr~combout\(1) & (\WAddr~combout\(0) & \Write~combout\))) # (!\RESET~combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \WAddr~combout\(1),
	datab => \WAddr~combout\(0),
	datac => \Write~combout\,
	datad => \RESET~combout\,
...
PORT MAP (
	clk => \cd|clk_tmp~clkctrl_outclk\,
	sdata => \rf|register_arr~7_combout\,
	sload => VCC,
...
\rf|register_arr[0][0]~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|register_arr[0][0]~3_combout\ = ((!\WAddr~combout\(1) & (!\WAddr~combout\(0) & \Write~combout\))) # (!\RESET~combout\)
...
PORT MAP (
	clk => \cd|clk_tmp~clkctrl_outclk\,
	datain => \rf|register_arr~7_combout\,
...
\rf|register_arr[2][1]~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|register_arr[2][1]~2_combout\ = ((\WAddr~combout\(1) & (!\WAddr~combout\(0) & \Write~combout\))) # (!\RESET~combout\)
...
PORT MAP (
	...
	datac => \Write~combout\,
	datad => \RESET~combout\,
	combout => \rf|register_arr[2][1]~2_combout\);
...
PORT MAP (
	...
	sdata => \rf|register_arr~7_combout\,
	sload => VCC,
	ena => \rf|register_arr[2][1]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \rf|register_arr[2][0]~regout\);

-- Location: LCCOMB_X2_Y15_N30
\rf|QA[0]~9\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[0]~9_combout\ = (\RA~combout\(1) & ((\RA~combout\(0)) # ((\rf|register_arr[2][0]~regout\)))) # (!\RA~combout\(1) & (!\RA~combout\(0) & (\rf|register_arr[0][0]~regout\)))
...
\rf|QA[0]~10\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[0]~10_combout\ = (\RA~combout\(0) & ((\rf|QA[0]~9_combout\ & ((\rf|register_arr[3][0]~regout\))) # (!\rf|QA[0]~9_combout\ & (\rf|register_arr[1][0]~regout\)))) # (!\RA~combout\(0) & (((\rf|QA[0]~9_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \rf|register_arr[1][0]~regout\,
	datab => \RA~combout\(0),
	datac => \rf|register_arr[3][0]~regout\,
	datad => \rf|QA[0]~9_combout\,
	combout => \rf|QA[0]~10_combout\);

-- Location: LCCOMB_X2_Y15_N6
\rf|register_arr[1][0]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|register_arr[1][0]~feeder_combout\ = \rf|register_arr~7_combout\
...
-- pragma translate_on
PORT MAP (
	datad => \rf|register_arr~7_combout\,
	combout => \rf|register_arr[1][0]~feeder_combout\);

-- Location: LCCOMB_X4_Y11_N0
\rf|register_arr[1][1]~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|register_arr[1][1]~1_combout\ = ((!\WAddr~combout\(1) & (\WAddr~combout\(0) & \Write~combout\))) # (!\RESET~combout\)
...
PORT MAP (
	...
	datac => \Write~combout\,
	datad => \RESET~combout\,
	combout => \rf|register_arr[1][1]~1_combout\);

-- Location: LCFF_X2_Y15_N7
\rf|register_arr[1][0]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \cd|clk_tmp~clkctrl_outclk\,
	datain => \rf|register_arr[1][0]~feeder_combout\,
	ena => \rf|register_arr[1][1]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\rf|QB[0]~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QB[0]~7_combout\ = (\RB~combout\(1) & ((\RB~combout\(0)) # ((\rf|register_arr[2][0]~regout\)))) # (!\RB~combout\(1) & (!\RB~combout\(0) & ((\rf|register_arr[0][0]~regout\))))
...
\rf|QB[0]~8\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QB[0]~8_combout\ = (\RB~combout\(0) & ((\rf|QB[0]~7_combout\ & (\rf|register_arr[3][0]~regout\)) # (!\rf|QB[0]~7_combout\ & ((\rf|register_arr[1][0]~regout\))))) # (!\RB~combout\(0) & (((\rf|QB[0]~7_combout\))))
...
-- Equation(s):
-- \rf|QB[0]~11_combout\ = (\ReadB~combout\ & \rf|QB[0]~8_combout\)
...
-- Equation(s):
-- \the_best_alu_in_kista|Mux3~7_combout\ = (\OP~combout\(0) & ((\rf|QB[0]~11_combout\) # ((\ReadA~combout\ & \rf|QA[0]~10_combout\)))) # (!\OP~combout\(0) & (\ReadA~combout\ & (\rf|QA[0]~10_combout\ & \rf|QB[0]~11_combout\)))
...
\rf|QA[0]~11\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[0]~11_combout\ = (\ReadA~combout\ & \rf|QA[0]~10_combout\)
...
PORT MAP (
	datab => \ReadA~combout\,
	datad => \rf|QA[0]~10_combout\,
	combout => \rf|QA[0]~11_combout\);
...
-- Equation(s):
-- \the_best_alu_in_kista|Add0~5_cout\ = CARRY(\OP~combout\(0))
...
PORT MAP (
	datab => \OP~combout\(0),
	datad => VCC,
	cout => \the_best_alu_in_kista|Add0~5_cout\);

-- Location: LCCOMB_X4_Y15_N20
\the_best_alu_in_kista|Add0~6\ : cycloneii_lcell_comb
-- Equation(s):
-- \the_best_alu_in_kista|Add0~6_combout\ = (\the_best_alu_in_kista|Add0~3_combout\ & ((\rf|QA[0]~11_combout\ & (\the_best_alu_in_kista|Add0~5_cout\ & VCC)) # (!\rf|QA[0]~11_combout\ & (!\the_best_alu_in_kista|Add0~5_cout\)))) # 
-- (!\the_best_alu_in_kista|Add0~3_combout\ & ((\rf|QA[0]~11_combout\ & (!\the_best_alu_in_kista|Add0~5_cout\)) # (!\rf|QA[0]~11_combout\ & ((\the_best_alu_in_kista|Add0~5_cout\) # (GND)))))
-- \the_best_alu_in_kista|Add0~7\ = CARRY((\the_best_alu_in_kista|Add0~3_combout\ & (!\rf|QA[0]~11_combout\ & !\the_best_alu_in_kista|Add0~5_cout\)) # (!\the_best_alu_in_kista|Add0~3_combout\ & ((!\the_best_alu_in_kista|Add0~5_cout\) # 
-- (!\rf|QA[0]~11_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \the_best_alu_in_kista|Add0~3_combout\,
	datab => \rf|QA[0]~11_combout\,
	datad => VCC,
	cin => \the_best_alu_in_kista|Add0~5_cout\,
	combout => \the_best_alu_in_kista|Add0~6_combout\,
	cout => \the_best_alu_in_kista|Add0~7\);
...
-- Equation(s):
-- \the_best_alu_in_kista|Mux3~4_combout\ = (\the_best_alu_in_kista|Mux2~4_combout\ & ((\the_best_alu_in_kista|Mux2~5_combout\ & (\rf|QA[0]~11_combout\)) # (!\the_best_alu_in_kista|Mux2~5_combout\ & ((\the_best_alu_in_kista|Add0~6_combout\))))) # 
...
-- pragma translate_on
PORT MAP (
	dataa => \rf|QA[0]~11_combout\,
	datab => \the_best_alu_in_kista|Mux2~4_combout\,
	datac => \the_best_alu_in_kista|Add0~6_combout\,
...
-- Equation(s):
-- \the_best_alu_in_kista|Mux3~5_combout\ = (\the_best_alu_in_kista|Mux2~6_combout\ & (((\the_best_alu_in_kista|Mux3~4_combout\)))) # (!\the_best_alu_in_kista|Mux2~6_combout\ & (\rf|QA[0]~11_combout\ $ (((\rf|QB[0]~11_combout\) # 
...
PORT MAP (
	...
	datab => \rf|QB[0]~11_combout\,
	datac => \rf|QA[0]~11_combout\,
	datad => \the_best_alu_in_kista|Mux3~4_combout\,
...
\rf|register_arr~6\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|register_arr~6_combout\ = (\RESET~combout\ & ((\IE~combout\ & ((\INPUT~combout\(1)))) # (!\IE~combout\ & (\the_best_alu_in_kista|SUM\(1)))))
...
PORT MAP (
	clk => \cd|clk_tmp~clkctrl_outclk\,
	sdata => \rf|register_arr~6_combout\,
	sload => VCC,
	ena => \rf|register_arr[3][1]~4_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	clk => \cd|clk_tmp~clkctrl_outclk\,
	datain => \rf|register_arr~6_combout\,
	ena => \rf|register_arr[1][1]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\rf|QA[1]~6\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[1]~6_combout\ = (\RA~combout\(0) & ((\RA~combout\(1)) # ((\rf|register_arr[1][1]~regout\)))) # (!\RA~combout\(0) & (!\RA~combout\(1) & (\rf|register_arr[0][1]~regout\)))
...
\rf|QA[1]~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[1]~7_combout\ = (\RA~combout\(1) & ((\rf|QA[1]~6_combout\ & (\rf|register_arr[3][1]~regout\)) # (!\rf|QA[1]~6_combout\ & ((\rf|register_arr[2][1]~regout\))))) # (!\RA~combout\(1) & (((\rf|QA[1]~6_combout\))))
...
PORT MAP (
	dataa => \RA~combout\(1),
	datab => \rf|register_arr[3][1]~regout\,
	datac => \rf|register_arr[2][1]~regout\,
	datad => \rf|QA[1]~6_combout\,
	combout => \rf|QA[1]~7_combout\);

-- Location: LCCOMB_X4_Y15_N4
\rf|QA[1]~8\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[1]~8_combout\ = (\ReadA~combout\ & \rf|QA[1]~7_combout\)
...
\the_best_alu_in_kista|Add0~8\ : cycloneii_lcell_comb
-- Equation(s):
-- \the_best_alu_in_kista|Add0~8_combout\ = ((\the_best_alu_in_kista|Add0~2_combout\ $ (\rf|QA[1]~8_combout\ $ (!\the_best_alu_in_kista|Add0~7\)))) # (GND)
-- \the_best_alu_in_kista|Add0~9\ = CARRY((\the_best_alu_in_kista|Add0~2_combout\ & ((\rf|QA[1]~8_combout\) # (!\the_best_alu_in_kista|Add0~7\))) # (!\the_best_alu_in_kista|Add0~2_combout\ & (\rf|QA[1]~8_combout\ & !\the_best_alu_in_kista|Add0~7\)))
...
PORT MAP (
	...
	datab => \rf|QA[1]~8_combout\,
	datad => VCC,
	cin => \the_best_alu_in_kista|Add0~7\,
...
-- Equation(s):
-- \the_best_alu_in_kista|Mux2~7_combout\ = (\the_best_alu_in_kista|Mux2~5_combout\ & (\the_best_alu_in_kista|Mux2~4_combout\ & (\rf|QA[1]~8_combout\))) # (!\the_best_alu_in_kista|Mux2~5_combout\ & (((\the_best_alu_in_kista|Add0~8_combout\)) # 
...
-- pragma translate_on
PORT MAP (
	dataa => \the_best_alu_in_kista|Mux2~5_combout\,
	datab => \the_best_alu_in_kista|Mux2~4_combout\,
	datac => \rf|QA[1]~8_combout\,
...
-- Equation(s):
-- \the_best_alu_in_kista|Mux2~8_combout\ = (\the_best_alu_in_kista|Mux2~6_combout\ & (((\the_best_alu_in_kista|Mux2~7_combout\)))) # (!\the_best_alu_in_kista|Mux2~6_combout\ & (\rf|QA[1]~8_combout\ $ (((\rf|QB[1]~10_combout\) # 
...
\rf|register_arr~5\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|register_arr~5_combout\ = (\RESET~combout\ & ((\IE~combout\ & ((\INPUT~combout\(2)))) # (!\IE~combout\ & (\the_best_alu_in_kista|SUM\(2)))))
...
PORT MAP (
	clk => \cd|clk_tmp~clkctrl_outclk\,
	sdata => \rf|register_arr~5_combout\,
	sload => VCC,
	ena => \rf|register_arr[2][1]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \rf|register_arr[0][2]~feeder_combout\ = \rf|register_arr~5_combout\
...
-- pragma translate_on
PORT MAP (
	datad => \rf|register_arr~5_combout\,
...
PORT MAP (
	clk => \cd|clk_tmp~clkctrl_outclk\,
	datain => \rf|register_arr~5_combout\,
	ena => \rf|register_arr[1][1]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\rf|QA[2]~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[2]~3_combout\ = (\RA~combout\(0) & ((\RA~combout\(1)) # ((\rf|register_arr[1][2]~regout\)))) # (!\RA~combout\(0) & (!\RA~combout\(1) & (\rf|register_arr[0][2]~regout\)))
...
PORT MAP (
	dataa => \RA~combout\(0),
	datab => \RA~combout\(1),
	datac => \rf|register_arr[0][2]~regout\,
	datad => \rf|register_arr[1][2]~regout\,
	combout => \rf|QA[2]~3_combout\);

-- Location: LCCOMB_X3_Y15_N12
\rf|QA[2]~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[2]~4_combout\ = (\RA~combout\(1) & ((\rf|QA[2]~3_combout\ & (\rf|register_arr[3][2]~regout\)) # (!\rf|QA[2]~3_combout\ & ((\rf|register_arr[2][2]~regout\))))) # (!\RA~combout\(1) & (((\rf|QA[2]~3_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \rf|register_arr[3][2]~regout\,
	datab => \RA~combout\(1),
	datac => \rf|register_arr[2][2]~regout\,
	datad => \rf|QA[2]~3_combout\,
	combout => \rf|QA[2]~4_combout\);
...
\rf|QB[2]~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QB[2]~3_combout\ = (\RB~combout\(1) & (\RB~combout\(0))) # (!\RB~combout\(1) & ((\RB~combout\(0) & ((\rf|register_arr[1][2]~regout\))) # (!\RB~combout\(0) & (\rf|register_arr[0][2]~regout\))))
...
PORT MAP (
	...
	datac => \rf|register_arr[0][2]~regout\,
	datad => \rf|register_arr[1][2]~regout\,
	combout => \rf|QB[2]~3_combout\);

-- Location: LCCOMB_X3_Y15_N30
\rf|QB[2]~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QB[2]~4_combout\ = (\RB~combout\(1) & ((\rf|QB[2]~3_combout\ & ((\rf|register_arr[3][2]~regout\))) # (!\rf|QB[2]~3_combout\ & (\rf|register_arr[2][2]~regout\)))) # (!\RB~combout\(1) & (((\rf|QB[2]~3_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \rf|register_arr[2][2]~regout\,
	datab => \RB~combout\(1),
	datac => \rf|register_arr[3][2]~regout\,
	datad => \rf|QB[2]~3_combout\,
	combout => \rf|QB[2]~4_combout\);

-- Location: LCCOMB_X3_Y15_N26
\rf|QB[2]~9\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QB[2]~9_combout\ = (\ReadB~combout\ & \rf|QB[2]~4_combout\)
...
PORT MAP (
	dataa => \ReadB~combout\,
	datad => \rf|QB[2]~4_combout\,
	combout => \rf|QB[2]~9_combout\);

-- Location: LCCOMB_X4_Y15_N0
\the_best_alu_in_kista|Mux1~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \the_best_alu_in_kista|Mux1~7_combout\ = (\OP~combout\(0) & ((\rf|QB[2]~9_combout\) # ((\ReadA~combout\ & \rf|QA[2]~4_combout\)))) # (!\OP~combout\(0) & (\ReadA~combout\ & (\rf|QA[2]~4_combout\ & \rf|QB[2]~9_combout\)))
...
PORT MAP (
	dataa => \ReadA~combout\,
	datab => \rf|QA[2]~4_combout\,
	datac => \OP~combout\(0),
	datad => \rf|QB[2]~9_combout\,
	combout => \the_best_alu_in_kista|Mux1~7_combout\);

-- Location: LCCOMB_X4_Y15_N6
\rf|QA[2]~5\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[2]~5_combout\ = (\ReadA~combout\ & \rf|QA[2]~4_combout\)
...
PORT MAP (
	datac => \ReadA~combout\,
	datad => \rf|QA[2]~4_combout\,
	combout => \rf|QA[2]~5_combout\);

-- Location: LCCOMB_X4_Y15_N24
\the_best_alu_in_kista|Add0~10\ : cycloneii_lcell_comb
-- Equation(s):
-- \the_best_alu_in_kista|Add0~10_combout\ = (\the_best_alu_in_kista|Add0~1_combout\ & ((\rf|QA[2]~5_combout\ & (\the_best_alu_in_kista|Add0~9\ & VCC)) # (!\rf|QA[2]~5_combout\ & (!\the_best_alu_in_kista|Add0~9\)))) # (!\the_best_alu_in_kista|Add0~1_combout\ 
-- & ((\rf|QA[2]~5_combout\ & (!\the_best_alu_in_kista|Add0~9\)) # (!\rf|QA[2]~5_combout\ & ((\the_best_alu_in_kista|Add0~9\) # (GND)))))
-- \the_best_alu_in_kista|Add0~11\ = CARRY((\the_best_alu_in_kista|Add0~1_combout\ & (!\rf|QA[2]~5_combout\ & !\the_best_alu_in_kista|Add0~9\)) # (!\the_best_alu_in_kista|Add0~1_combout\ & ((!\the_best_alu_in_kista|Add0~9\) # (!\rf|QA[2]~5_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \the_best_alu_in_kista|Add0~1_combout\,
	datab => \rf|QA[2]~5_combout\,
	datad => VCC,
...
-- Equation(s):
-- \the_best_alu_in_kista|Mux1~4_combout\ = (\the_best_alu_in_kista|Mux2~5_combout\ & (\the_best_alu_in_kista|Mux2~4_combout\ & ((\rf|QA[2]~5_combout\)))) # (!\the_best_alu_in_kista|Mux2~5_combout\ & (((\the_best_alu_in_kista|Add0~10_combout\)) # 
-- (!\the_best_alu_in_kista|Mux2~4_combout\)))
...
PORT MAP (
	dataa => \the_best_alu_in_kista|Mux2~5_combout\,
	datab => \the_best_alu_in_kista|Mux2~4_combout\,
	datac => \the_best_alu_in_kista|Add0~10_combout\,
	datad => \rf|QA[2]~5_combout\,
	combout => \the_best_alu_in_kista|Mux1~4_combout\);

-- Location: LCCOMB_X4_Y15_N28
\the_best_alu_in_kista|Mux1~5\ : cycloneii_lcell_comb
-- Equation(s):
-- \the_best_alu_in_kista|Mux1~5_combout\ = (\the_best_alu_in_kista|Mux2~6_combout\ & (((\the_best_alu_in_kista|Mux1~4_combout\)))) # (!\the_best_alu_in_kista|Mux2~6_combout\ & (\rf|QA[2]~5_combout\ $ (((\rf|QB[2]~9_combout\) # 
...
PORT MAP (
	dataa => \the_best_alu_in_kista|Mux2~6_combout\,
	datab => \rf|QB[2]~9_combout\,
	datac => \rf|QA[2]~5_combout\,
...
-- Location: LCFF_X5_Y15_N19
\the_best_alu_in_kista|SUM[2]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \cd|clk_tmp~clkctrl_outclk\,
	datain => \the_best_alu_in_kista|Mux1~6_combout\,
	aclr => \ALT_INV_RESET~clkctrl_outclk\,
	ena => \alu_en~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\rf|register_arr~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|register_arr~0_combout\ = (\RESET~combout\ & ((\IE~combout\ & ((\INPUT~combout\(3)))) # (!\IE~combout\ & (\the_best_alu_in_kista|SUM\(3)))))
...
PORT MAP (
	clk => \cd|clk_tmp~clkctrl_outclk\,
	datain => \rf|register_arr~0_combout\,
	ena => \rf|register_arr[0][0]~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\rf|QB[3]~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QB[3]~0_combout\ = (\RB~combout\(1) & ((\RB~combout\(0)) # ((\rf|register_arr[2][3]~regout\)))) # (!\RB~combout\(1) & (!\RB~combout\(0) & ((\rf|register_arr[0][3]~regout\))))
...
PORT MAP (
	dataa => \RB~combout\(1),
	datab => \RB~combout\(0),
	datac => \rf|register_arr[2][3]~regout\,
	datad => \rf|register_arr[0][3]~regout\,
	combout => \rf|QB[3]~0_combout\);

-- Location: LCCOMB_X3_Y15_N22
\rf|QB[3]~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QB[3]~1_combout\ = (\RB~combout\(0) & ((\rf|QB[3]~0_combout\ & ((\rf|register_arr[3][3]~regout\))) # (!\rf|QB[3]~0_combout\ & (\rf|register_arr[1][3]~regout\)))) # (!\RB~combout\(0) & (((\rf|QB[3]~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \rf|register_arr[1][3]~regout\,
	datab => \RB~combout\(0),
	datac => \rf|register_arr[3][3]~regout\,
	datad => \rf|QB[3]~0_combout\,
	combout => \rf|QB[3]~1_combout\);

-- Location: LCCOMB_X3_Y15_N16
\rf|QA[3]~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[3]~0_combout\ = (\RA~combout\(1) & ((\RA~combout\(0)) # ((\rf|register_arr[2][3]~regout\)))) # (!\RA~combout\(1) & (!\RA~combout\(0) & ((\rf|register_arr[0][3]~regout\))))
...
PORT MAP (
	...
	datac => \rf|register_arr[2][3]~regout\,
	datad => \rf|register_arr[0][3]~regout\,
	combout => \rf|QA[3]~0_combout\);

-- Location: LCCOMB_X3_Y15_N8
\rf|QA[3]~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[3]~1_combout\ = (\RA~combout\(0) & ((\rf|QA[3]~0_combout\ & ((\rf|register_arr[3][3]~regout\))) # (!\rf|QA[3]~0_combout\ & (\rf|register_arr[1][3]~regout\)))) # (!\RA~combout\(0) & (((\rf|QA[3]~0_combout\))))
...
PORT MAP (
	dataa => \rf|register_arr[1][3]~regout\,
	datab => \RA~combout\(0),
	datac => \rf|QA[3]~0_combout\,
	datad => \rf|register_arr[3][3]~regout\,
	combout => \rf|QA[3]~1_combout\);

-- Location: LCCOMB_X4_Y15_N16
\rf|QA[3]~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \rf|QA[3]~2_combout\ = (\ReadA~combout\ & \rf|QA[3]~1_combout\)
...
PORT MAP (
	datac => \ReadA~combout\,
	datad => \rf|QA[3]~1_combout\,
	combout => \rf|QA[3]~2_combout\);

-- Location: LCCOMB_X5_Y15_N26
\the_best_alu_in_kista|Mux0~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \the_best_alu_in_kista|Mux0~7_combout\ = (\OP~combout\(0) & ((\rf|QA[3]~2_combout\) # ((\ReadB~combout\ & \rf|QB[3]~1_combout\)))) # (!\OP~combout\(0) & (\ReadB~combout\ & (\rf|QB[3]~1_combout\ & \rf|QA[3]~2_combout\)))
...
PORT MAP (
	dataa => \OP~combout\(0),
	datab => \ReadB~combout\,
	datac => \rf|QB[3]~1_combout\,
	datad => \rf|QA[3]~2_combout\,
	combout => \the_best_alu_in_kista|Mux0~7_combout\);

-- Location: LCCOMB_X3_Y15_N14
\the_best_alu_in_kista|Add0~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \the_best_alu_in_kista|Add0~0_combout\ = \OP~combout\(0) $ (((\ReadB~combout\ & \rf|QB[3]~1_combout\)))
...
-- Equation(s):
-- \the_best_alu_in_kista|Add0~12_combout\ = \rf|QA[3]~2_combout\ $ (\the_best_alu_in_kista|Add0~11\ $ (!\the_best_alu_in_kista|Add0~0_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \rf|QA[3]~2_combout\,
	datad => \the_best_alu_in_kista|Add0~0_combout\,
...
-- Equation(s):
-- \the_best_alu_in_kista|Mux0~4_combout\ = (\the_best_alu_in_kista|Mux2~5_combout\ & (\rf|QA[3]~2_combout\ & (\the_best_alu_in_kista|Mux2~4_combout\))) # (!\the_best_alu_in_kista|Mux2~5_combout\ & (((\the_best_alu_in_kista|Add0~12_combout\) # 
-- (!\the_best_alu_in_kista|Mux2~4_combout\))))
...
-- Equation(s):
-- \the_best_alu_in_kista|Mux0~5_combout\ = (\the_best_alu_in_kista|Mux2~6_combout\ & (((\the_best_alu_in_kista|Mux0~4_combout\)))) # (!\the_best_alu_in_kista|Mux2~6_combout\ & (\rf|QA[3]~2_combout\ $ (((\rf|QB[3]~2_combout\) # 
...
-- pragma translate_on
PORT MAP (
	dataa => \rf|QB[3]~2_combout\,
	datab => \rf|QA[3]~2_combout\,
	datac => \the_best_alu_in_kista|Mux2~6_combout\,
...
-- Equation(s):
-- \the_best_alu_in_kista|Mux0~6_combout\ = (\OP~combout\(1) & ((\OP~combout\(2) & ((\the_best_alu_in_kista|Mux0~5_combout\))) # (!\OP~combout\(2) & (\the_best_alu_in_kista|Mux0~7_combout\)))) # (!\OP~combout\(1) & 
...
-- Equation(s):
-- \the_best_alu_in_kista|z_tmp~0_combout\ = (!\the_best_alu_in_kista|Mux2~9_combout\ & (!\the_best_alu_in_kista|Mux3~6_combout\ & (!\the_best_alu_in_kista|Mux0~6_combout\ & !\the_best_alu_in_kista|Mux1~6_combout\)))
...
\the_best_alu_in_kista|o_tmp~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \the_best_alu_in_kista|o_tmp~4_combout\ = (\OP~combout\(1) & ((\OP~combout\(2) & ((\the_best_alu_in_kista|Mux0~5_combout\))) # (!\OP~combout\(2) & (\the_best_alu_in_kista|Mux0~7_combout\)))) # (!\OP~combout\(1) & 
-- (((\the_best_alu_in_kista|Mux0~5_combout\))))
...
PORT MAP (
	...
	datac => \OP~combout\(2),
	datad => \the_best_alu_in_kista|Mux0~5_combout\,
	combout => \the_best_alu_in_kista|o_tmp~4_combout\);

-- Location: LCCOMB_X5_Y15_N16
\the_best_alu_in_kista|o_tmp~5\ : cycloneii_lcell_comb
-- Equation(s):
-- \the_best_alu_in_kista|o_tmp~5_combout\ = (\rf|QA[3]~2_combout\ & (\ReadB~combout\ & (\rf|QB[3]~1_combout\ & !\the_best_alu_in_kista|o_tmp~4_combout\))) # (!\rf|QA[3]~2_combout\ & (\the_best_alu_in_kista|o_tmp~4_combout\ & ((!\rf|QB[3]~1_combout\) # 
-- (!\ReadB~combout\))))
...
PORT MAP (
	...
	datab => \rf|QA[3]~2_combout\,
	datac => \rf|QB[3]~1_combout\,
	datad => \the_best_alu_in_kista|o_tmp~4_combout\,
	combout => \the_best_alu_in_kista|o_tmp~5_combout\);

-- Location: LCFF_X5_Y15_N17
\the_best_alu_in_kista|O_Flag\ : cycloneii_lcell_ff
PORT MAP (
	clk => \cd|clk_tmp~clkctrl_outclk\,
	datain => \the_best_alu_in_kista|o_tmp~5_combout\,
	ena => \the_best_alu_in_kista|Z_Flag~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
